                  ...
                  children: [
                    Container(
                      ...
                      child: Text('Store Place',
                          style: GoogleFonts.roboto(
                              fontSize: size.dp(5.0), color: btnPrimaryColor, fontWeight: FontWeight.bold)),
                    ),
                    Container(
                    ...
                    Container(
                      ...
                      child: Text('Ingrese su código de verificación',
                          style: GoogleFonts.roboto(
                              fontSize: size.dp(2.0), color: textPrimaryColor, fontWeight: FontWeight.bold)),
                    ),
                    Column(
                      children: [
                        Container(
                          margin: EdgeInsets.symmetric(horizontal: size.wp(30.0)),
                          child: Form(
                            key: _forKeyCode,
                            child: TextFormField(
                              validator: (text) {
                        ...
                        Container(
                          margin: EdgeInsets.symmetric(horizontal: size.dp(5.0), vertical: size.dp(3.0)),
                          decoration: BoxDecoration(color: accentColor, borderRadius: BorderRadius.circular(25.0)),
                          child: MaterialButton(
                              child: Text('Ingresar',
                                  style: GoogleFonts.roboto(
                                      fontSize: size.dp(2.0), color: Colors.white, fontWeight: FontWeight.normal)),
