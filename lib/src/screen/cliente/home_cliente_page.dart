              ...
              child: (controller.nameSearch.isNotEmpty)
                  ? FutureBuilder(
                      ...
                      builder: (BuildContext context,
                          AsyncSnapshot<SearchClientes> snapshot) {
                        ...
                        if (snapshot.hasData) {
                          return (snapshot.data.clientes.length == 0)
                              ? FutureBuilder(
                                  ...
                                  builder: (BuildContext context,
                                      AsyncSnapshot<Clientes> snapshot) {
                                    final Responsive size =
                                        Responsive.of(context);
                                        
                                    if (snapshot.hasData) {
                                      return (snapshot.data.clientes.length ==
                                              0)
                                          ? BannerSinDatos(
                                              label: 'Clientes',
                                              size: size,
                                          ...
                                          : ListView.builder(
                                              ...
                                              itemCount:
                                                  snapshot.data.clientes.length,
                                              itemBuilder:
                                                  (BuildContext context,
                                                      int index) {
                                                final cliente = snapshot
                                                    .data.clientes[index];
                                                return ItemClientes(
                                                  size: size,
                                                  cliente: cliente,
