...
//===================================================================//
  //=========================RESGISTROS CLIENTES=======================//
  //===================================================================//
  Future<ApiResponse<Clientes>> listarClientes() async {
    try {
      final response = await this._dio.get(
            '/clientes/',
          );
      final data = Clientes.fromJson(response.data);
      return ApiResponse<Clientes>(data, null);
    } catch (e) {
      final error = apiErrorMessage(e);
      return ApiResponse<Clientes>(null, error);
    }
  }
  ...
  //===================================================================//
  Future<ApiResponse> newCliente(
      String ced, String nom, String tel, String email, String dir, String obs, String coord) async {
    try {
  ...
  //===================================================================//
  Future<bool> uptadeCliente(
      String id, String ced, String nom, String tel, String email, String dir, String obs, String coord) async {
    try {
  ...
  //===================================================================//
  Future<bool> newUsuario(String cedula, String nombre, String celular, String email, String codigo, String rol) async {
    try {
  ...
  //===================================================================//
  Future<bool> uptadeUsuario(String id, String nombre, String celular, String email, String codigo, String rol) async {
    try {
      final response = await this._dio.put('/usuarios/' + id,
          data: {"nombres": nombre, "celular": celular, "email": email, "codigo": codigo, "rol": rol});
      _logger.i(response.data);
      // final data = Cliente.fromJson(response.data);
      // print(response.data);
      return true;
